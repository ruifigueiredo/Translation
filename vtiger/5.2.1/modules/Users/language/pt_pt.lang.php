...
'LBL_MODULE_TITLE'=>'Utilizadores: Home',
'LBL_SEARCH_FORM_TITLE'=>'Pesquisa de Utlizadores',
'LBL_LIST_FORM_TITLE'=>'Lista de Utilizadores',
'LBL_NEW_FORM_TITLE'=>'Utilizador Novo',
'LBL_CREATE_NEW_USER'=>'Criar Novo Utilizador',
'LBL_LOGIN'=>'Login',
'LBL_USER_ROLE'=>'Papel',
'LBL_LIST_NAME'=>'Nome',
...
'LBL_LIST_CONFIRM_PASSWORD'=>'Confirmar Password',
'LBL_LIST_USER_NAME_ROLE'=>'ID do Utilizador , Nome & Papel',
'LBL_LIST_SELECT'=>'Seleccionar',
'LBL_LIST_PHONE'=>'Telefone',
'LBL_LIST_NO'=>'#',

'LBL_ADMINS'=>'Admins',
'LBL_STD_USERS'=>'Utilizador Normal',
...
'LBL_STATUS'=>'Status',
'LBL_TITLE'=>'Titulo',
'LBL_ANY_PHONE'=>'Qualquer Phone:',
'LBL_ANY_EMAIL'=>'Qualquer Email:',
'LBL_ADDRESS'=>'Morada',
'LBL_CITY'=>'Cidade',
'LBL_STATE'=>'Localidade',
'LBL_POSTAL_CODE'=>'Código Postal',
'LBL_COUNTRY'=>'Pais',
'LBL_USER_SETTINGS'=>'Configurações do Utilizador',
'LBL_USER_INFORMATION'=>'Informações do Utilizador',
'LBL_MOBILE_PHONE'=>'Telemovel',
'LBL_OTHER'=>'Outro',
'LBL_FAX'=>'Fax',
'LBL_EMAIL'=>'E-Mail Id',
'LBL_HOME_PHONE'=>'Telefone de Casa',
'LBL_ADDRESS_INFORMATION'=>'Morada do Utilizador',
'LBL_CAL_HRFORMAT'=>'Formato da data no Calendário',
'LBL_CAL_DURATION'=>'Dia começa as',
'LBL_PRIMARY_ADDRESS'=>'Morada Principal:',

'LBL_CHANGE_PASSWORD_BUTTON_TITLE'=>'Alterar Password [Alt+P]',
'LBL_CHANGE_PASSWORD_BUTTON_KEY'=>'P',
'LBL_CHANGE_PASSWORD_BUTTON_LABEL'=>'Alterar Password',
'LBL_LOGIN_BUTTON_TITLE'=>'Iniciar Sessão [Alt+L]',
'LBL_LOGIN_BUTTON_KEY'=>'L',
'LBL_LOGIN_BUTTON_LABEL'=>'Iniciar Sessão',
'LBL_LOGIN_HISTORY_BUTTON_TITLE'=>'Histórico de Acessos [Alt+H]',
'LBL_LOGIN_HISTORY_BUTTON_KEY'=>'H',
'LBL_LOGIN_HISTORY_BUTTON_LABEL'=>'Histórico de Acessos',
'LBL_LOGIN_HISTORY_TITLE'=>'Utilizadores: Histórico de Acessos',
'LBL_RESET_PREFERENCES'=>'Reset To Default Preferences',

'LBL_CHANGE_PASSWORD'=>'Mudar Password',
'LBL_OLD_PASSWORD'=>'Password Antiga:',
'LBL_NEW_PASSWORD'=>'Password Nova:',
'LBL_CONFIRM_PASSWORD'=>'Confirmação da Nova Password:',
'ERR_ENTER_OLD_PASSWORD'=>'Introduza a password antiga.',
'ERR_ENTER_NEW_PASSWORD'=>'Introduza a password nova.',
'ERR_ENTER_CONFIRMATION_PASSWORD'=>'Introduza a confirmação da password.',
'ERR_REENTER_PASSWORDS'=>'Volte a Introduzir a password.  A "Nova Password" e a "Password Antiga" não são iguais.',
'ERR_INVALID_PASSWORD'=>'Deverá introduzir um Nome de Utilizador e Password válidos',
'ERR_PASSWORD_CHANGE_FAILED_1'=>'A alteração da password do utilizador falhou porque ',
'ERR_PASSWORD_CHANGE_FAILED_2'=>' falhou.  Deverá ser definida uma nova password.',
'ERR_PASSWORD_INCORRECT_OLD'=>'Incorrect old password specified. Re-enter password information.',
'ERR_USER_NAME_EXISTS_1'=>'O Nome de Utilizador ',
'ERR_USER_NAME_EXISTS_2'=>' já existe.  Não é possível existirem Nome de Utilizadores iguais.<br>Altere o Nome de Utilizador de modo a que seja único.',
'ERR_LAST_ADMIN_1'=>'O Nome de Utilizador ',
'ERR_LAST_ADMIN_2'=>' é o último Utilizador Admin. Deverá existir sempre pelo menos um Utilizador Admin.<br>Verifique as Configurações do utilizador Admin.',

'ERR_DELETE_RECORD'=>"Para apagar o Utilizador, é necessário indicar um um número de registo.",
...
'LBL_CREATE_NEW_ROLE'=>'Criar novo Papel',
'LBL_INDICATES_REQUIRED_FIELD'=>'Indicates Required Field',
'LBL_NEW_ROLE'=>'Novo Papel',
'LBL_PARENT_ROLE'=>'Papel Pai',

'LBL_LIST_ROLES'=>'Lista de Papéis',
...
'LBL_ROLE_DETAILS'=>'Detailhes do Papel',
//added for vtigercrm4 rc
'LBL_FILE'=> 'Nome do Ficheiro',
'LBL_FILE_TYPE'=>'Tipo de Ficheiro',
'LBL_UPLOAD'=>'Enviar Ficheiro',
...
'LBL_TEMPLATE_FILE'=>'Ficheiro do Template',
...
'LBL_SELECT_MODULE'=>'Seleccionar Modulo',
'LBL_MERGE_FILE'=>'Ficheiro : ',
'LBL_MERGE_MSG'=>'Select a module to assign this Template',
'LBL_MERGE_FIELDS'=>'Unir Campos',
'LBL_COPY_PASTE'=>'Colar & Colar',
'LNK_GO_TO_TOP'=>'Ir para o Topo',
'LBL_COLON'=>':',
...
'LBL_SUBJECT'=>'Assunto',
'LBL_BODY'=>'Corpo do Email',
'LBL_TEMPLATE_TOOLS'=>'Ferramentas',
'LBL_TEMPLATE_PUBLIC'=>'Acesso Publico',
'LBL_TEMPLATE_PRIVATE'=>'Acesso Privado',
'LBL_TEMPLATE_SUBJECT'=>'Assunto do Email',
'LBL_TEMPLATE_MESSAGE'=>'Mensagem do Email',
'LBL_VIEWING'=>'Viewing',
'LBL_PROPERTIES'=>'Propriedades de ',
...
'LBL_GROUP_DETAILS'=>'Detailhes do Grupo',
'LBL_MEMBER'=>'Membros',
'LBL_MEMBER_AVLBL'=>'Available Entities & Members',
'LBL_MEMBER_SELECTED'=>'Seleccionar Membros',
...
'LBL_CUSTOMISE_TABS'=>'Personalizar Separadores',
'LBL_CHOOSE_TABS'=>'Escolher Separadores',
'LBL_AVAILABLE_TABS'=>'Separadores Disponíveis',
'LBL_SELECTED_TABS'=>'Separadores Escolhidos',
'LBL_USER'=>'Utilizador',
...
'LBL_MY_ADDR'=>'Minha Morada Postal',
'LBL_MY_PHOTO'=>'Minha Foto',
'LBL_CHANGE_PHOTO'=>'Alterar Foto...',
'LBL_CHANGE'=>'Alterar',
...
'LBL_DELETE_ROLE'=>'Apagar Papel',
'LBL_MORE_INFORMATION'=>'Mais Informação',
'LBL_USERLOGIN_ROLE'=>'Login do Utilizador & Papel',
'LBL_USER_IMAGE_INFORMATION'=>'Fotografia do Utilizador',
...
'LBL_SHOWN'=>'Mostrar',
'LBL_HIDDEN'=>'Escondigo',
'LBL_SHOW'=>'Mostrar',
'LBL_HIDE'=>'Esconder',
'LBL_HOME_PAGE_COMP'=>'Home Page Components',
'LBL_LOGIN_HISTORY'=>'Histórico de Acessos',
...
'LBL_ADD_MAIL_ACCOUNT'=>'Adicionar Conta de Email',
'LBL_NEW_MAIL_ACCOUNT_TITLE'=>'Nova Conta de Email [Alt+M]',
'LBL_NEW_MAIL_ACCOUNT_KEY'=>'M',
'LBL_NEW_MAIL_ACCOUNT_LABEL'=>'Nova Conta de Email',
...
'User Login Details'=>'Detalhes de Acesso do Utilizador',
'LBL_TO_LOGIN' => 'para Login',

// Added after 5.0.4 GA

'LBL_USER_ADV_OPTIONS'=>'Opções Avançados do Utilizador',
