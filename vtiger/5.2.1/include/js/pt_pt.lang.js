 ...
 ********************************************************************************/
	...
	var alert_arr = {       DELETE:'Are you sure you want to delete the selected ',
                                RECORDS:' registos?',
                                SELECT:'Por favor, seleccione pelo menos uma entidade',
                                DELETE_ACCOUNT:'Apagar esta(s) conta(s) irá remover as Oportunidades e Orçamentos associados. Tem a certeza que deseja apagar os',
                                ...
                                SELECT_MAILID:'Por favor seleccione um mailid',
                                OVERWRITE_EXISTING_ACCOUNT1:'Sobrepor a morada existente com os dados da morada da conta seleccionada (',
                                OVERWRITE_EXISTING_ACCOUNT2:') ?',
				                OVERWRITE_EXISTING_CONTACT1:'Sobrepor a morada existente com os dados da morada do contacto seleccionado (',
                                OVERWRITE_EXISTING_CONTACT2:') ?',
                                MISSING_FIELDS:'Faltam campos requeridos:',
                                NOT_ALLOWED_TO_EDIT:'não está autorizado a editar este campo',
                                NOT_ALLOWED_TO_EDIT_FIELDS:'não está autorizado a editar o(s) campo(s)',
                                COLUMNS_CANNOT_BE_EMPTY:'Colunas seleccionadoas não podem estar vazias',
                                ...
                                SHOULDBE_EQUAL:' deverá ser igual à ',
                                SHOULDBE_GREATER:' deverá ser maior que ',
                                SHOULDBE_GREATER_EQUAL:' deverá ser maior ou igual a ',
                                INVALID:'Inválido ',
                                ...
                                ADD_CONFIRMATION:'Tem a certeza que quer adicionar os ',
                                ...
                                DOESNOT_HAVE_AN_MAILID:'" '+"Não tem um Email Id",
                                MISSING_REQUIRED_FIELDS:'Faltam campos requeridos: ',
                                READONLY:"é somente de leitura",
				SELECT_ATLEAST_ONE_USER:'Por favor seleccione pelo menos 1 utilizador',
                                DISABLE_SHARING_CONFIRMATION:'Tem a certeza que deseja desactivar partilha para o(s) utilizadore(s) seleccionados ',
                                USERS:' ?',
                                ENDTIME_GREATER_THAN_STARTTIME:'Data de Termino deverá ser superior a data de Início ',
                                FOLLOWUPTIME_GREATER_THAN_STARTTIME:'Followup Time should be greater than End Time ',
                                MISSING_EVENT_NAME:'Falta nome do Evento',
                                EVENT_TYPE_NOT_SELECTED:'Tipo de Evento não está seleccionado',
                                CLOSEDATE_CANNOT_BE_EMPTY:'Close Date field cannot be empty',
                                SITEURL_CANNOT_BE_EMPTY:'Url do Site não pode estar vazio',
                                SITENAME_CANNOT_BE_EMPTY:'Nome do Site não pode estar vazio',
                                LISTPRICE_CANNOT_BE_EMPTY:'Preço Listado não pode estar vazio',
                                INVALID_LIST_PRICE:'Preço Listado Inválido',
                                PROBLEM_ACCESSSING_URL:'Problema em aceder ao url: ',
                                CODE:' Código: ',
                                ...
                                ERROR:'Erro',
                                FIELD_TYPE_NOT_SELECTED:'Tipo do campo não está seleccionado',
                                SPECIAL_CHARACTERS_NOT_ALLOWED:'Special characters are not allowed in Label field',
				SPECIAL_CHARACTERS:'Caracteres especiais ',
                                NOT_ALLOWED:'não são permitidos. Por favor tente com outros valores',
                                ...
                                THE_EMAILID: "O email id \'",
                                EMAIL_FIELD_INVALID:"\' no campo de email é inválido",
                                MISSING_REPORT_NAME:'Falta Nome do Relatório',
                                ...
                                SURE_TO_DELETE:'Tem a certeza que deseja remover ?',
				NO_PRODUCT_SELECTED:'Nenhum produto está seleccionado. Escolha pelo menos um Produto',
				...
				NO_SPECIAL_CHARS:'Caracteres Especiais não são permitidos na linha da Factura',
				PLS_SELECT_VALID_FILE:'Please select a file with the following extension:\n',
                                NO_SPECIAL:'Special Characters are not allowed',
				NO_QUOTES:'Aspas (\' ") e o símbolo + não são permitidos ',
				IN_PROFILENAME:' no Nome de Perfil',
				IN_GROUPNAME:' no Nome de Grupo',
				IN_ROLENAME:' no Nome de Papel',
				...
				IN_USERNAME :' no Nome de Utilizador ',
				LBL_ENTER_VALID_NO: 'Por favor introduza um número válido',
				...
				LBL_DOWNLOAD_ATTACHMENTS : 'Download do Anexo', 
